...
foreach($data as $object){
    ...
    $list .= "<tr>";
    $list .= "<td>".$object->s_addr_id."</td>";
    $list .= "<td>".$object->s_addr_title."</td>";
    $list .= "<td class='text-center'>
               <a onclick='return confirm('Are You Sure To Delete This!')'; href='".site_url("addresses/delete_address/".$object->s_addr_id)."' class='trash_btn ml10' title='Delete User'><i class='fa fa-trash-o'></i><a>
                  <a href='".site_url("addresses/update_address/".$object->s_addr_id)."'
