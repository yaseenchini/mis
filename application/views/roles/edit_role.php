...
<div class="row">
	...
	<div class="box border blue" id="messenger">
		...
		<div class="box-body">
            ...
            <form class="form-horizontal" role="form" method="post" id="role_form" action="<?php echo site_url("roles/edit_role/".$role->role_id); ?>">
              ...
              <div class="form-group">
				 ...
				 <div class="col-md-10"> 
					<label class="radio"> <input type="radio" class="uniform" name="role_status" value="1" <?php echo radio_checked($role->role_status, "1"); ?> /> Active </label> 
					<label class="radio"> <input type="radio" class="uniform" name="role_status" value="0" <?php echo radio_checked($role->role_status, "0"); ?> /> Inactive </label> 
					</div>
			  </div>
