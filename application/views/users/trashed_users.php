...
foreach($data as $object){
    ...
    $list .= "<td class='text-center'>
                    <a href='".site_url("users/restore_user/".$object->user_id)."' class='ml10' title='Restore User'><i class='fa fa-undo'></i><a>
                    <a href='".site_url("users/delete_user/".$object->user_id)."' class='trash_btn ml10' title='Delete User'><i class='fa fa-ban'></i><a>
                  </td>";
    $list .= "</tr>";
}
