...
if(!empty($colddrink))
{
foreach($colddrink as $colddrinks){
  
    $list .= "<tr>";
    $list .= "<td>".$colddrinks->colddrink_id."</td>";
    $list .= "<td>".$colddrinks->colddrink."</td>";
    $list .= "<td>".$colddrinks->liter."</td>";
    $list .= "<td class='text-center'>
                    <a href='".site_url("colddrink/update_colddrink/".$colddrinks->colddrink_id)."'
                    onclick='return confirm('Are You Sure To Delete This!')'; class='ml10' title='Edit User'><i class='fa fa-edit'></i><a>
                    <a href='".site_url("colddrink/delete_colddrink/".$colddrinks->colddrink_id)."' class='trash_btn ml10' title='Delete User'><i class='fa fa-trash-o'></i><a>
                  </td>";
    $list .= "</tr>";
}
}
