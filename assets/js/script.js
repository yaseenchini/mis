...
* @param display_length number of records to be displyed integer
* @param def_sor_col default sorting column (integer from 0)
* @param sort_order asc or desc
* @param server_side boolean load from server or not
*/
function apply_dt(table_id, display_length, def_sort_col, sort_order, server_side, ajax){
                                
    //default values of arguments
    if (typeof(table_id) === "undefined") { table_id = "datatable"; }
    if (typeof(display_length) === "undefined") { display_length = 50; }
    if (typeof(def_sort_col) === "undefined") { def_sort_col = 1; }
    if (typeof(sort_order) === "undefined") { sort_order = "asc"; }
    if (typeof(server_side) === "undefined") { server_side = false; }
    if (typeof(ajax) === "undefined") { ajax = "databales_server_error.php"; }
    ...
    jQuery('#'+table_id).dataTable({
		...
		"aaSorting": [[ def_sort_col, '"'+sort_order+'"' ]]
  });
